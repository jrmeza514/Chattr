...
var Chattr = function () {
  ...
  */
  ...
  /*
    ...
    add it to the DOM
  */
  SOCKET_CALLBACKS.onMessage = function (message) {
    CHAT_MESSAGES.push(message);
    var chatItem = createChatMessage(message);
  ...
  /*
    ...
    messges to the DOM
  */
  SOCKET_CALLBACKS.onLoadChat = function (chattrBuffer) {
  ...
  /*
    ...
    to use
  */
  SOCKET_CALLBACKS.onConnected = function () {
  ...
  */
  ...
  var UI_CONNECT = document.getElementById('connect');
  var UI_CHATBOX = document.getElementById('chatbox');
  var UI_CHATBOX_SEND = document.getElementById('chatboxSend');
  var UI_CHATLIST = document.getElementById('chatList');
  ...
  */
  function createChatMessage(message) {
    ...
    */
    ...
    var chatItem__header = document.createElement('div');
    ...
    var chatItem__message = document.createElement('div');
